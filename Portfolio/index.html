...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    <a class="navbar-brand js-scroll-trigger" href="#page-top">
      ...
      <!--Write your Name here! -->
      <span class="d-block d-lg-none">Muhammad Arshad</span>
      <span class="d-none d-lg-block">
        <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="c:\Users\user\Pictures\Saved Pictures\Arshad rehan.jpg">
      </span>
    </a>
  ...
  <div class="container-fluid p-0">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="about">
      <div class="w-100">
        ...
        <h1 class="mb-0">Muhammad Arshad

        </h1>
        <!--Enter your Mobile Number here! -->
        <div class="subheading mb-5">(+92) 305-6615505 
          <br>

          <!--Enter your Email Address -->
          <a href="muhammadarshadrehan@.gmail.com">muhammadarshadrehan@google.com</a>
        </div>

        <!-- Description / About Me! (Yahha khul ke Likhen) -->
        <p class="lead mb-5">
          Muhammad Arshad is a curious learner who always tries to understand things deeply and improve himself every day. He believes that hard work and the desire to learn can create a strong future.
        </p>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex justify-content-center" id="experience">
      <div class="w-100">
        <h2 class="mb-5">Experience</h2>
         ...
         <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          ...
          <div class="resume-date text-md-right">
            <span class="text-primary">Aug 2025 - Present</span>
          </div>
        </div>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          ...
          <div class="resume-date text-md-right">
            <span class="text-primary">May 2027 - Present</span>
          </div>
        </div>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          ...
          <div class="resume-date text-md-right">
            <span class="text-primary">Jan 2025 - May 2026</span>
          </div>
        </div>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          ...
          <div class="resume-date text-md-right">
            <span class="text-primary">July 2024 - jan 2025</span>
          </div>
        </div>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
          ...
          <div class="resume-date text-md-right">
            <span class="text-primary">jan 2023 - June 2024</span>
          </div>
        </div>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="education">
      <div class="w-100">
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
           <!--Bachelor's-->
          <div class="resume-content">
            <h3 class="mb-0">FAST-NUCES(National Univesity Computer Engineering Science)</h3>
            <div class="subheading mb-3">Software Engineering</div>
            </div>

        <div class="resume-date text-md-right">
            <span class="text-primary">Aug2025 - Aug 2029</span>
          </div>
        </div>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
           <!--College Here -->
          <div class="resume-content">
            <h3 class="mb-0">Punjab Group of college Multan</h3>
            <div class="subheading mb-3">Pre-Engineering</div>
            </div>

        <div class="resume-date text-md-right">
            <span class="text-primary">Aug 2023 - Aug 2025</span>
          </div>
        </div>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
           <!--School Here -->
          <div class="resume-content">
            <h3 class="mb-0">Misali Science Secondary School<b></h3>
            <div class="subheading mb-3">Computer Science</div>
            </div>

        <div class="resume-date text-md-right">
            <span class="text-primary">Aug 2021- Aug 2022</span>
          </div>
        </div>
        </div>
    </section>
